<?php 
//idcategorie
//1 NIKE/ 2 New Balance/ 3 Adidas/ 4 Zara/ 5 Bershka
                                        ...
                                        <div class="card">
                                            <div class="row">
                                                <div class="card-body col-md-5 product-img-outer text-center">
                                                    <?php if (isset($ligne['chemin']) && !empty($ligne['chemin'])): ?>
                                                        <img class="product_image rounded" style="height: 300px; width: 300px" src="../<?= $ligne['chemin'] ?>" alt="...">
                                                    <?php else: ?>
                                                        <img class="product_image rounded" style="height: 300px; width: 300px" src="../path/to/default-image.jpg" alt="Image par défaut">
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="card-body col-7 text-start">
                                                    ...
                                                    <ul class="product-variation">                                                
                                                        ...
                                                        <?php endif; ?>
                                                        <!-- selon si c'est une livraison ou en main propre, un different badge est mis -->
                                                    </ul>
                                                    <p><?= $ligne['detail'] ?></p> <br>
