...
<html lang="fr">
<head>
    <title>Detail annonce - Stone Island</title>
                                    ...
                                    <div class="card">
                                        ...
                                        <ul class="product-variation">
                                            ...
                                            <?php elseif ($categorie==2): ?>
                                                <a class="badge badge-pill badge-warning">Nike<i class="fa-solid fa-user-secret mx-2"></i></a>
                                            <?php elseif ($categorie==3): ?>
                                                <a class="badge badge-pill badge-info">New balance<i class="fa-solid fa-rocket mx-2"></i></a>
                                            <?php elseif ($categorie==4): ?>
                                                <a class="badge badge-pill badge-danger">Adidas<i class="fa-solid fa-feather-pointed mx-2"></i></a>
                                            <?php else: ?>
                                                <a class="badge badge-pill badge-success">Zara<i class="fa-solid fa-earth-europe mx-2"></i></a>
                                            <?php endif; ?>
